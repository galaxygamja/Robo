...
> 최신 변경: **드론 없음 정상 실행, 공통 작업·경로 최적화, 정상/간헐 누락/지속 가림의 공정 비교**.
> [최신 실행법·변경 내용·비교 결과](docs/COORDINATION_COMPARISON_FIX_KO.md)를 먼저 보세요.
> 2026-09-06 로컬 검증: 비전 의존성 포함 Python **272개**, 웹 **52개** 통과, skip 0.
...
- B1·B2의 큐브: 2개씩 사전 적재하여 H 2개/PCC 각각1개 배분. 별도 배출 서보 모의.
...
웹 공통 최적화의 기본 58초와 5대 혼잡 시험 59.80초는 가상 주행 시간이며 Python의 단순 합성 시간과 성능 비교하면 안 됩니다. 정상 정보가 같으면 드론 유무로 시간을 인위적으로 바꾸지 않습니다. 간헐 누락 비교는 드론 없음 65.82초/드론 관측 58초입니다.
