...
> 최신 변경: **박쥐 드론의 이동 관측·가림 복구·로봇별 위치 입력 보완·동일 조건 비교**.
> [최신 실행법·변경 내용·비교 결과](docs/DRONE_ADVANTAGE_RELEASE_KO.md)를 먼저 보세요.
> 2026-09-06 로컬 검증: 비전 의존성 포함 Python **272개**, 웹 **45개** 통과, skip 0.
...
웹 기본 78.66초와 5대 혼잡 시험 76.72초는 가상 주행 시간이며 Python의 단순 합성 시간과 성능 비교하면 안 됩니다.
