...
> 최신 변경: **햄스터 1대·비버 3대**, 실시간 좌표 추적과 색 원기둥 후보 검출.
> [코드 감사·실행법·5대 확장 시험 결과](docs/LOCALIZATION_RELEASE_KO.md)를 먼저 보세요.
...
웹의 약 73초는 가상 주행 시간이며 Python의 단순 합성 시간과 성능 비교하면 안 됩니다.
