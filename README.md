...
`1,143 × 1,181mm` 경기장, `480 × 280mm` 출발구역을 사용합니다. 6대를
...
공식 B-1/B-2 배치가 아직 공개되지 않아 장애물·목표 위치는 **임시 검증용**이고,
실제 AI 최적화나 로봇 명령 송신은 연결하지 않았습니다. RC카 분석 결과와
...
2026-09-05 재검증에서 Python 34개, 웹 시뮬레이터 11개 테스트가 모두
