...
현재 기본 팀은 지상로봇 4대와 관측 드론 1대이며, 더 이상 지상로봇 6대가 아닙니다.
...
- 박쥐: 시작 구역 이륙·상공 관측 모의. 끄면 고정 카메라 관측을 가정.
...
실제 영상 인식·모터·드론·무선통신은 미연결입니다. 이 코드는 실물 완주시간이나 비행 허용을 보장하지 않습니다.
